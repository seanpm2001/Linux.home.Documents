...
使用DuckDuckGo保護您在Chrome上的隱私只會對您搜索的內容有所幫助，但Google仍會挖掘您的數據，因此效果不佳。
...
[6-EFF（電子前沿基金會）-Google的FLoC是一個糟糕的主意]（https://www.eff.org/deeplinks/2021/03/googles-floc-terrible-idea）
