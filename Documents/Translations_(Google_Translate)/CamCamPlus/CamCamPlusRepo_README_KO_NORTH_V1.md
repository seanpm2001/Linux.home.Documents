...
! [{Project icon}이 이미지를로드하지 못했습니다. 파일에 도달하지 못했거나 일반적인 오류 때문일 수 있습니다. 가능한 일반 오류를 수정하려면 페이지를 새로 고침하세요.] (/ Docs / Graphics / iOS6 / JPEG / Camera_iOS6_Placeholder.jpeg)
...
유지 관리 문제로 인해 많은 번역이 구버전이며이`README` 기사 파일의 오래된 버전을 사용하고 있습니다. 번역가가 필요합니다. 또한 2021 년 4 월 22 일부로 모든 새 링크가 작동하는 데 시간이 걸릴 것입니다.
...
# CamCamPlus
CamCamPlus는 다양한 형식과 다양한 해상도로 사진과 비디오를 촬영할 수있는 고급 무료 오픈 소스 카메라입니다.

***

## 정보

위 참조. 이 프로젝트는 많은 옵션을 제공하고 다른 일반적인 카메라 앱이 가진 장벽 (예 : 30 분 녹화 제한)을 무너 뜨리는 강력한 오픈 소스 카메라에 관한 것입니다.

***

## 위키

[이 프로젝트 위키를 보려면 여기를 클릭 / 탭하세요] (https://github.com/seanpm2001/CamCamPlus/wiki)
...
이 스티커는 Fre에 의해 지원됩니다e 소프트웨어 재단. 내 작업에 DRM을 포함시킬 생각은 없습니다.
...
> * 1. [seanpm2001] (https://github.com/seanpm2001/)-커밋 138 개 (2021 년 4 월 22 일 목요일 오후 6시 30 분 현재)
...
[프로젝트 언어 파일] (PROJECT_LANG.cpp)

[이 프로젝트의 연구 자료실] (/ References /)

[이 프로젝트의 특별 영상 모듈 (SVG 비디오)] (https://github.com/seanpm2001/SVG_Video/)

[GitHub 토론 참여] (https://github.com/seanpm2001/CamCamPlus/discussions)
...
파일 버전 : '1 (2021 년 4 월 22 일 목요일 오후 6시 30 분)'
...
버전 1 (2021 년 4 월 22 일 목요일 오후 6시 30 분)
