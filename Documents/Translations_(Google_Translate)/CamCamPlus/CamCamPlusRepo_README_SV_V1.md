...
! [{Project icon} Den här bilden kunde inte laddas. Det kan bero på att filen inte nås eller ett allmänt fel. Ladda om sidan för att åtgärda ett möjligt allmänt fel.] (/ Docs / Graphics / iOS6 / JPEG / Camera_iOS6_Placeholder.jpeg)
...
På grund av underhållsproblem är många översättningar föråldrade och använder en föråldrad version av denna `README`-artikelfil. En översättare behövs. Från och med den 22 april 2021 kommer det att ta mig ett tag att få alla nya länkar att fungera.
...
# CamCamPlus
CamCamPlus är en avancerad gratis kamera med öppen källkod som kan ta bilder och videor i många format och många upplösningar.

***

## Handla om

Se ovan. Det här projektet handlar om en öppen källkod med kraftfull kamera som ger många alternativ och bryter ner hinder som andra vanliga kameraappar har (till exempel 30 minuters inspelningsgräns)

***

## Wiki

[Klicka / tryck här för att se projektets Wiki] (https://github.com/seanpm2001/CamCamPlus/wiki)
...
> * 1. [seanpm2001] (https://github.com/seanpm2001/) - 138 åtaganden (Från och med torsdagen den 22 april 2021 kl. 18:30)
...
[Språkfil för projektet] (PROJECT_LANG.cpp)

[Forskningsreferensbibliotek för detta projekt] (/ Referenser /)

[Den speciella videomodulen för detta projekt (SVG Video)] (https://github.com/seanpm2001/SVG_Video/)

[Gå med i diskussionen om GitHub] (https://github.com/seanpm2001/CamCamPlus/discussions)
...
Filversion: '1 (torsdag 22 april 2021 kl. 18:30)'
...
Version 1 (torsdagen den 22 april 2021 kl. 18.30)
