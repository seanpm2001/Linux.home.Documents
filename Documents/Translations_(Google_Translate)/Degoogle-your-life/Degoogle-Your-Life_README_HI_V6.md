...
[07.0 - लिंक डाउनलोड करें] (# डाउनलोड-लिंक)
...
एक बेहतर विवरण, [Wuest3nFuchs] (https://github.com/Wuest3nFuchs) - स्रोत: [Wuest3nFuchs / Degoogle] (https://github.com/Wuest3nFuchs/Degoogle) द्वारा प्रदान किया गया
...
[आपको ReCaptcha का उपयोग क्यों रोकना चाहिए] (https://github.com/seanpm2001/Why-you-should-stop-use-ReCaptcha) <! - 4! - 4>
...
[आपको Google स्लाइड का उपयोग क्यों रोकना चाहिए] (https://github.com/seanpm2001/Why-you-should-stop-use-Google-Slides) <! - 24! ->
...
[आपको Google वीडियो का उपयोग क्यों रोकना चाहिए] (https://github.com/seanpm2001/Why-you-should-stop-using-Google-Video) <! - 44! ->
...
क्रोम (और कई अन्य ब्राउज़रों) में एक गुप्त मोड मौजूद है। क्रोम में, यह मोड व्यर्थ है, क्योंकि Google अभी भी आपका डेटा मेरा होगा। यहां तक ​​कि अगर आप डेटा माइनिंग / ट्रैकिंग बंद कर देते हैं, और "ट्रैक न करें" सिग्नल को सक्षम करते हैं, तो आश्चर्य की बात, Google अभी भी आपके डेटा को खनन कर रहा है।
...
Google धरती -> OpenStreetMaps / Apple मैप्स
...
Google ने अपनी प्रोग्रामिंग भाषा `गो` (2009 से, 6 साल बाद) के साथ 2003 एजेंट आधारित प्रोग्रामिंग भाषा` गो! Google की इस बात के लिए बहुत आलोचना की गई, क्योंकि उनके `डोन्ट बी डोंट 'मोटो उस समय भी सक्रिय थे, और यह उन कई घटनाओं में से एक है, जिन्हें दुष्ट आदर्श वाक्य रिटायर नहीं किया गया।
...
यहां तक ​​कि Google स्वयं भी अपनी साइटों को केवल क्रोम बना रहा है। उदाहरण के लिए, Google खोज आपको हर 10 सेकंड में Chrome को 3 बार डाउनलोड करने के लिए संकेत देगा यदि यह पता लगाता है कि आप Google Chrome (यहां तक ​​कि अन्य क्रोमियम-आधारित ब्राउज़र जैसे कि बहादुर प्रभावित हैं) का उपयोग नहीं कर रहे हैं और Google धरती जैसी साइटें फ़ायरफ़ॉक्स उपयोगकर्ताओं को अनुमति नहीं देती हैं उनकी साइट का उपयोग करें (2020 तक) साथ ही Google अनुवाद फ़ायरफ़ॉक्स और अन्य गैर-Google Chrome ब्राउज़र पर ध्वनि इनपुट का समर्थन नहीं करता है।
...
एक कंपनी को पूरी तरह से स्वचालित नहीं होना चाहिए। Google इसका एक उदाहरण है। मॉडरेशन भयानक है जब केवल एआई द्वारा किया जाता है, तो YouTube एक अच्छा उदाहरण है, यहां तक ​​कि अतिरिक्त कुछ (सैकड़ों, या शायद एक हजार) लोग साइट को मॉडरेट कर रहे हैं, जहां यह स्पष्ट रूप से इतना बुरा है कि उनमें से अधिकांश को काम करते समय चिकित्सा प्राप्त करना है।

***

## एंड्रॉयड

Android Google के स्वामित्व में है। ओपन हैंडसेट एलायंस का हिस्सा (जो एंड्रॉइड के बाद से ओपन नहीं हुआ है) एंड्रॉइड Google के लिए एक और एकाधिकार बिंदु बन गया है, और बचने के लिए बहुत कठिन है।

Android को प्रति दिन कम से कम 10 बार Google को फ़ोन करने की सूचना दी गई है, और आंशिक रूप से खुले स्रोत होने के बावजूद, यह अभी भी स्पाइवेयर के रूप में भारी काम करता है।

एंड्रॉइड से वैकल्पिक करने के लिए कई प्रोजेक्ट बनाए गए हैं, लेकिन आपके डिवाइस को रूट करने की आवश्यकता है। नॉक्स डीआरएम की वजह से अमेरिका में विशिष्ट सैमसंग फोन के लिए यह अब संभव नहीं है। एंड्रॉइड के सामान्य विकल्पों में iOS, iPadOS, LineageOS, Android x86, Ubuntu Touch और PiPhone (Pi Phone एक ब्रांड के फोन हैं, जो फ़ेडोरा, उबंटू, आर्क, आदि जैसे मोबाइल डिवाइस पर विभिन्न लिनक्स सिस्टम चलाते हैं)

[डीगोइंग एंड्रॉइड वर्चुअल मशीन कार्यात्मक होने पर मेरा शोध देखें] (https://github.com/Degoogle-your-life/Degoogled_Android_Phone_VM_Research)

[देखें कि Android से कैसे डिलीट करें] (https://github.com/Degoogle-your-life/Why-you-should-stop-use-Android)

***

## मदद करने के लिए छोटे कार्य

हर तरह से जागरूकता फैलाना आपके लिए महत्वपूर्ण है। मेरे लिए, मैं न केवल बार-बार डीगोइंग के बारे में बात करता हूं, और लेख लिखता हूं, बल्कि मुझे एक छोटी सी आदत भी है, जहां मैं जागरूकता बढ़ाने के लिए r / degoogle पर पिन किए गए पोस्ट पर अपना दैनिक मुफ्त रेडिट पुरस्कार देता हूं। अब तक, मैंने पिन किए गए पोस्ट को लगभग 30 पुरस्कार दिए हैं (मैंने उस पोस्ट के लिए 10 पुरस्कारों पर अपने मुफ्त सिक्कों में से 500 भी खर्च किए हैं)

***

## अविश्वसनीय

Google पर भरोसा नहीं किया जा सकता है, और कभी भी फिर से भरोसा नहीं किया जा सकता है। वे पूरी तरह से "बुराई मत बनो" (वे हमेशा बुरे थे) से पूरी तरह से बुराई हो रही है और इसे छिपाने की कोशिश नहीं कर रहे हैं।
...
इस लेख के लिए कुछ तथ्य जांचना आवश्यक है
...
लाइन की गिनती (रिक्त लाइनों और संकलक लाइन सहित): `968`

फ़ाइल संस्करण: `6 (रविवार, अप्रैल 1821 रात 4:18 बजे)`
...
संस्करण 1 (शुक्रवार, फरवरी 19 2021 शाम 5:20 बजे)

> परिवर्तन:

> * फाइल शुरू की

> * मूल विवरण अनुभाग जोड़ा गया

> * रिपॉजिटरी विवरण अनुभाग जोड़ा गया

> * 14 प्रविष्टियों के साथ लेख सूची में जोड़ा गया

>> * एक `संबंधित लेख` अनुभाग जोड़ा गया

>> * एक `` भी देखें अनुभाग जोड़ा गया
...
संस्करण 2 (शुक्रवार, 19 फरवरी 2021 को शाम 5:26 बजे)

> परिवर्तन:

> * अनुवाद स्थिति अनुभाग जोड़ा गया

> * सेक्शन को चेक करने के लिए अन्य चीजों को जोड़ा

> * गोपनीयता अनुभाग जोड़ा गया

> * एक इंडेक्स जोड़ा गया

> * सॉफ्टवेयर स्थिति उपधारा जोड़ा गया

> * अन्य Google विरोधी अभियान अनुभाग जोड़ा गया

>> * दोषपूर्ण उपधारा जोड़ा गया

>> * चल रही उपधारा जोड़ा गया

> * स्रोत अनुभाग जोड़ा गया

> * डाउनलोड लिंक अनुभाग जोड़ा गया
...
संस्करण 3 (बुधवार, फरवरी 24 वीं 2021 शाम 7:56 बजे)

> परिवर्तन:

> * इंडेक्स को अपडेट करें

> * डीआईएन आइकन और नए गिटहब संगठन को संदर्भित किया

> * नए लेखों के लिंक जोड़े

> * काउंटरिंग अन्य तर्कों अनुभाग जोड़ा गया

>> * सुविधा उपधारा जोड़ा गया

>> * क्यों भी उपधारा परेशान

>> * अन्य उपधारा जोड़ा गया
...
संस्करण 4 (मंगलवार, 25 फरवरी 2021 रात 9:31 बजे)

> परिवर्तन:

> * 10 नए लेखों के लिंक जोड़े

> * मेरे अनुभव degoogling के बारे में एक खंड जोड़ा गया
...
संस्करण 5 (शुक्रवार, 9 अप्रैल 2021 शाम 6:02 बजे)

_ हाल ही में मुझसे Google विरोधी आंदोलन के अपडेट की कमी है, मैं 1 महीने के अंतराल के बाद इसे वापस पाने के लिए काम कर रहा हूं ।_
...
> * भाषा सूची अपडेट करें: निश्चित लिंक, और अधिक समर्थित भाषाओं को जोड़ा

> * लेख स्थिति अनुभाग अद्यतन, 4 कांटा लिंक जोड़ने

> * सॉफ्टवेयर स्टेटस सेक्शन को अपडेट करें

> * गो बुराई सेक्शन है

> * DRM सेक्शन का उपयोग जोड़ा गया

> * आम गलतफहमी अनुभाग जोड़ा गया

>> * जोड़ा गया Google इंटरनेट उपधारा नहीं है

> * इंटरनेट एक्सप्लोरर 6 और क्रोम अनुभाग जोड़ा गया

>> * बहादुर उपधारा के साथ समस्या गयी

> * अशुद्ध गोपनीयता हटाने जोड़ा गया

> * जोड़ा गया ओपन सोर्स आंशिक उपधारा नहीं हो सकता है

> * ऑक्सीमोरन उपधारा जोड़ा गया

> * खराब प्रदर्शन अनुभाग जोड़ा गया

> * खराब परियोजना प्रबंधन अनुभाग जोड़ा गया

> * सेवा अनुभाग के भयानक या कोई मॉडरेशन जोड़ा गया

> * एस्ट्रोटर्फिंग खंड जोड़ा गया

> * अवैध और अनैतिक व्यापार प्रथाओं अनुभाग जोड़ा गया

> * यूरोप उपधारा में जोड़ा गया

>> * उत्तरी अमेरिका के उप-क्षेत्र में जोड़ा गया

>> * विवाद उपधारा जोड़ा गया

> * जोड़ा गया Google स्वचालित अनुभाग है

> * Android अनुभाग जोड़ा गया

> * मदद करने के लिए छोटी क्रियाओं को जोड़ा

> * अविश्वसनीय अनुभाग जोड़ा गया
...
संस्करण 6 (रविवार, 18 अप्रैल 2021 को शाम 4:18 बजे)

> परिवर्तन:

> * इंडेक्स को अपडेट करें

> * एक नया अवलोकन विवरण जोड़ा गया

> * अद्यतन लेख स्थिति जानकारी

> * नए Google FLoC लेख का लिंक जोड़ा गया

> * इस पर वूस्ट 3 एन फ्यूच्स डीओओएक्स लेख और सामान्य जानकारी के लिए एक लिंक जोड़ा गया
...
((शीर्ष पर वापस जाएँ] (# शीर्ष) | [GitHub पर लौटें] (https://github.com))
