...
[ChromeBooks ашиглахаа зогсоох] (https://github.com/seanpm2001/Stop-using-Chromebooks) <! - 2! ->
...
[Та яагаад Google Play Store ашиглахаа болих хэрэгтэй вэ] (https://github.com/seanpm2001/Why-you-should-stop-using-the-Google-Play-Store) <! - 22! ->
...
[Та яагаад Googles WebP дүрсний форматыг ашиглахаа болих хэрэгтэй вэ] (https://github.com/seanpm2001/Why-you-should-stop-using-Google-WebP) <! - 42! ->
...
[Та яагаад Tenor (2019 оноос хойш Google-ийн эзэмшдэг GIF сайт) -ийг ашиглахаа болих хэрэгтэй вэ]] (https://github.com/seanpm2001/Why-you-should-stop-using-Google-Tenor) <! - 62! - ->
...
Google-ийн бүх бүтээгдэхүүнийг тагнуулын програм агуулсан тул Google-ийн бүтээгдэхүүний нууцлал үргэлж муу байдаг.
...
### Яагаад хамаагүй, ямар ч байсан оройтсон
...
[Таван нүдний холбоо] (https://en.wikipedia.org/wiki/Five_Eyes) [Арван есөн наян дөрөв] (https://en.wikipedia.org/wiki/Nineteen_Eighty-Four)
...
Google Streetview -> Хэзээ ч ашиглагдаагүй тул би үүнийг илүү аймшигтай гэж үздэг
...
Эцэст нь "Go!" -Ийн хөгжил зогссон бол "Go" нь улам бүр түгээмэл болжээ. Google тэд "Яв!" Гэж сандрахгүй гэж мэдэгдсэн боловч эцэст нь тэд үүнийг хийсэн бөгөөд тэд үүнээс мултарчээ (2021 оны 4-р сарын 9-ний байдлаар)
...
Энэ нийтлэлд зарим баримтыг шалгах шаардлагатай байна
...
Шугамын тоо (хоосон мөр, хөрвүүлэгчийн мөрийг оруулаад): `968`

Файлын хувилбар: "6 (2021 оны 4-р сарын 18-ны Ням гараг, 16:18 цагт)"
...
> *Ивээн тэтгэгчийн мэдээллийн хэсгийг нэмсэн

> * Хувилбар 0.1-д өөр өөрчлөлт ороогүй болно

Хувилбар 1 (2021 оны 2-р сарын 19-ний Баасан гараг, 17:20 цагт)

> Өөрчлөлт:

> * Файлыг эхлүүлсэн

> * Үндсэн тайлбар хэсгийг нэмж оруулсан

> * Хадгалах сангийн тодорхойлолтын хэсгийг нэмсэн

> * Нийтлэлийн жагсаалтыг 14 оруулгатай нэмсэн

>> * "Холбогдох нийтлэл" хэсгийг нэмсэн

>> * `Бас харах` хэсгийг нэмж оруулсан

> * Файлын мэдээллийн хэсгийг нэмсэн

> * Файлын түүх хэсгийг нэмж оруулсан

> * Хөлийг нэмж оруулав

> * Хувилбар 1-т өөр өөрчлөлт ороогүй болно

Хувилбар 2 (2021 оны 2-р сарын 19-ний Баасан гараг, 17:26 цагт)

> Өөрчлөлт:

> * Орчуулгын байдлын хэсгийг нэмж оруулсан

> * Шалгах бусад зүйлийг нэмж оруулав

> * Нууцлалын хэсгийг нэмж оруулсан

> * Индекс нэмсэн

> * Програм хангамжийн статусын дэд хэсгийг нэмсэн

> * Google-ийн эсрэг бусад кампанит ажлын хэсгийг нэмсэн

>> * Зогссон дэд хэсгийг нэмсэн

>> * Одоо байгаа дэд хэсгийг нэмж оруулсан

> * Эх сурвалж хэсгийг нэмж оруулсан

> * Татаж авах холбоосуудын хэсгийг нэмж оруулсан
...
Хувилбар 3 (2021 оны 2-р сарын 24-ний Лхагва гараг, 19:56 цагт)

> Өөрчлөлт:

> * Индексийг шинэчилсэн

> * Degoogle дүрс болон шинэ GitHub байгууллагад хандсан болно

> * Шинэ өгүүллүүдийн холбоосууд нэмэгдсэн

> * Бусад аргументын эсрэг хэсгийг нэмж оруулсан

>> * Тохиромжтой дэд хэсгийг нэмсэн

>> * Why even bother дэд хэсгийг нэмсэн

>> * Бусад дэд хэсгийг нэмсэн

> * Зарим өгөгдлийг шинэчилсэн
...
Хувилбар 4 (2021 оны 2-р сарын 25-ны Пүрэв гараг, 21:31 цагт)

> Өөрчлөлт:

> * 10 шинэ өгүүлэлд холбоос нэмсэн

> * Миний degoogling туршлагын талаар хэсэг нэмсэн
...
Хувилбар 5 (2021 оны 4-р сарын 9-ний Баасан гараг, 18:02 цагт)

_ Сүүлийн үед надаас Google-ийн эсрэг хөдөлгөөнийг шинэчлэх асуудал хомс байгаа тул би 1+ сар завсарласны дараа эргэн орохоор ажиллаж байна.
...
> * Хэлний жагсаалтыг шинэчилсэн: тогтмол холбоосууд, мөн илүү олон хэлийг нэмж оруулсан

> * Нийтлэлийн статусын хэсгийг шинэчилж, 4 салаа холбоос нэмж оруулав

> * Програм хангамжийн статус хэсгийг шинэчилсэн

> * Go is evil гэсэн хэсгийг нэмж оруулсан

> * DRM-ийн хэрэглээ хэсгийг нэмж оруулсан

> * Нийтлэг буруу ойлголт хэсгийг нэмсэн

>> * Google нэмсэн нь интернетийн дэд хэсэг биш юм

> * Internet Explorer 6 ба Chrome хэсгийг нэмсэн

>> * Brave дэд хэсэгт асуудал нэмэгдлээ

> * Хуурамч нууцлалыг арилгахыг нэмсэн

> * Нээлттэй эхийг нэмж оруулсан нь хэсэгчилсэн дэд хэсэг байж болохгүй

> * Oxymoron дэд хэсгийг нэмсэн

> * Муу гүйцэтгэлийн хэсгийг нэмсэн

> * Муу төслийн менежмент хэсгийг нэмж оруулсан

> * Үйлчилгээний аймшигтай эсвэл огт зохицуулдаггүй хэсгийг нэмж оруулсан

> * Astroturfing хэсгийг нэмсэн

> * Хууль бус, ёс зүйгүй бизнесийн үйл ажиллагааны хэсгийг нэмж оруулсан

> * Европ дахь дэд хэсгийг нэмсэн

>> * Хойд Америк дахь дэд хэсгийг нэмсэн

>> * Маргаантай дэд хэсгийг нэмсэн

> * Google-ийг автоматжуулсан хэсэг дээр нэмсэн

> * Android хэсгийг нэмсэн

> * Туслах хэсгийг жижиг үйлдлүүд дээр нэмсэн

> * Найдваргүй хэсгийг нэмсэн
...
Хувилбар 6 (2021 оны 4-р сарын 18-ны Ням гараг, 16:18 цагт)

> Өөрчлөлт:

> * Индексийг шинэчилсэн

> * Шинэ тойм тайлбар нэмж оруулав

> * Өгүүллийн статусын мэдээллийг шинэчилсэн

> * Шинэ Google FLoC нийтлэлд холбоос нэмсэн

> * Wuest 3n Fuchs Degoogle-ийн холбоос болон түүний ерөнхий мэдээллийг холбоос нэмсэн
...
([Дээшээ эргэх] (# Топ) | [GitHub руу буцах] (https://github.com))
