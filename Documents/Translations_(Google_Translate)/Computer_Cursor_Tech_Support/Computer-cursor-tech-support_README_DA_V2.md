...
For at geninstallere din mus, prøv dette script (kun testet på Linux, IKKE MACOS)
...
* Lad aldrig dit batteri falde til under 'x' procent (20-31% anbefales som 'x')
...
> * Tilføjet sektionen ekstreme løsninger
