...
> * 1. [seanpm2001] (https://github.com/seanpm2001/) - x commits (à partir de DoW, Month, DoM, Yr à ##: ## a / pm)
...
[Fichier de langue du projet] (PROJECT_LANG. <fileExtensionForProgrammingLanguage>)

[Rejoignez la discussion sur GitHub] (https://github.com/seanpm2001/ <repoName> / discussions)
...
> * Ajout de la section `suppression de la télémétrie`

> * Ajout de la section `retrait de la porte dérobée`
